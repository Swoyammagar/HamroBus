              ...
              {/* Heading */}
                ...
                <View className="mt-4">
                    <TouchableOpacity className="bg-[#27AE60] rounded-lg p-9 py-3 mb-4">
                        <Text className="text-white text-center text-base font-medium" onPress={()=>router.push("/passenger/phone")}>Sign Up as Passenger</Text>
                    </TouchableOpacity>
                    <TouchableOpacity className="bg-[#27AE60] rounded-lg py-3">
                        <Text className="text-white text-center text-base font-medium" onPress={()=>router.push("/driver/phonePage")}>Sign Up as Driver</Text>
                    </TouchableOpacity>
                </View>   
            </View>
          </View>
