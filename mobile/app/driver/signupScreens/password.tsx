...
const NewPassword: React.FC = () => {
  ...
  const { signupData, resetSignupData } = useDriverSignup();
          ...
          <View className="w-full mt-6 flex-col lg:flex-row items-center justify-between max-w-[1200px]">
            ...
            <View style={{ width: "100%", maxWidth: 510 }}>
              ...
              {errors.confirmPassword ? (
                ...
                {/* <View className="relative">
                    <Text className="font-extralight text-[#333] mt-3 mb-1">must be at least 5 characters long</Text>
                    <Text className="font-extralight text-[#333] mt-2 mb-1">must have one uppercase and lowercase letter</Text>
